// The AWS RDS certificate authority bundle (global-bundle.pem), kept in
// lockstep with the Duranta Go backend's embedded copy
// (backend/static/rds-ca-certs.pem).
// eslint-disable-next-line max-lines
export const rdsCaBundle = `-----BEGIN CERTIFICATE-----
